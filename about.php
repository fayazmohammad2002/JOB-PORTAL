...
<html lang="en">
  <head>
    <title>Vignan's groups &mdash;placements</title>
    <meta charset="utf-8">
...
<div class="site-wrap">
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="col-md-6">
            <img src="images/fayaz1.jpg" alt="Image" width="250" class="img-fluid mb-4 rounded">
          </div>

          <div class="col-md-6">
            <h3>Shaik Fayaz Mohammad</h3>
          ...
          <div class="col-md-6 order-md-2 ml-md-auto">
            <img src="images/uday.jpg" alt="Image" width="250"class="img-fluid mb-4 rounded">
          </div>

          <div class="col-md-6">
            <h3>Venkata Uday Chand</h3>
            <p class="text-muted">Creative Director</p>
            <div class="social mt-4">
              <a href="#"><span class="icon-facebook"></span></a>
              <a href="#"><span class="icon-twitter"></span></a>
      ...
      <div class="col-md-6">
            <img src="images/eswar.jpg" alt="Image" width="250" class="img-fluid mb-4 rounded">
          </div>
          ...
          <div class="col-md-6 order-md-2 ml-md-auto">
            <img src="images/srihari1.jpg" alt="Image" width="250" class="img-fluid mb-4 rounded">
          </div>
