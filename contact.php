        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Vignan University vadlamudi</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">123456789</a></p>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="block__87154 bg-white rounded">
              ...
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="images/fayaz.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Shaik Mohammed Fayaz</h3>
          ...
          <div class="col-lg-6">
            <div class="block__87154 bg-white rounded">
              ...
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="images/uday.jpg" alt="Image" class="img-fluid"></figure>
                <div>
